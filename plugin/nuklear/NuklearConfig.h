...
struct NuklearConfig {

  static NuklearConfig ForWindow(ResourceID window);
...
inline NuklearConfig NuklearConfig::ForWindow(ResourceID window) {
  NuklearConfig config;
