...
#include "D3D11VertexDataFactory.h"

namespace xEngine {

void D3D11VertexDataFactory::Create(D3D11VertexData &resource) {
...
void D3D11VertexDataFactory::Destroy(D3D11VertexData &resource) {
