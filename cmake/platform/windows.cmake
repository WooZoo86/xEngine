...
set(CMAKE_CXX_FLAGS "${X_VS_RTTI_FLAGS} /EHa /MP /WX /TP /DWIN32 /DX_WINDOWS=1 /D_CRT_SECURE_NO_WARNINGS")
set(CMAKE_CXX_FLAGS_DEBUG "/Zi /Od /Oy- /MTd /D_DEBUG /D_DEBUG_ /DX_DEBUG=1")
set(CMAKE_CXX_FLAGS_RELEASE "/Ox /MT /DNDEBUG")

set(CMAKE_C_FLAGS "/MP /WX /TC /errorReport:queue /DWIN32 /DX_WINDOWS=1 /D_CRT_SECURE_NO_WARNINGS")
set(CMAKE_C_FLAGS_DEBUG "/Zi /Od /Oy- /MTd /D_DEBUG /D_DEBUG_ /DX_DEBUG=1")
